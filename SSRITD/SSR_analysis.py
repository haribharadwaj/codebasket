...
subjlist = [
    'I02', 'I03', 'I05', 'I06', 'I08', 'I09', 'I11', 'I13', 'I14', 'I15', 'I17',
    ...
    for condind, cond in enumerate(condlist):
        ...
        if os.path.isfile(respath + save_raw_name):
            ...
            for k, edfname in enumerate(bdfs):
                ...
                # Filter the data
                raw.filter(
                    l_freq=10, h_freq=200, picks=np.arange(0, 32, 1))

                conds = {
                    '50us': 8, '100us': 9, '200us': 10, '400us': 11, '800us': 12}
        ...
        params = dict(
            Fs=2048.0, fpass=[5, 600], tapers=[1, 1], pad=1, Npairs=2000,
            itc=1)
