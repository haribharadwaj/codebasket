...
def plotSSRResults(subjlist, what,summary = False, max = False,
                     ch_sel = 30, OnlyReturn = True):
        
    #froot = '/home/hari/Documents/PythonCodes/research/SSRITD/EEG/'   
    froot = '/home/hari/Documents/SSRresults/'
...
what = 'N'
N = plotSSRResults(subjlist,what)
what = 'cplv'
cplv = plotSSRResults(subjlist,what)
what = 'S'
S = plotSSRResults(subjlist,what)
what = 'Sraw'
Sraw = plotSSRResults(subjlist,what)

what = 'pS'
pS = plotSSRResults(subjlist,what)