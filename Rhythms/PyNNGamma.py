...
Isyn = sim.StaticSynapse(weight=0.1, delay=1.0)
...
sine = sim.ACSource(start=50.0, stop=850.0, amplitude=2.0, offset=1.0,
                    frequency=4.0, phase=180.0)
...
pl.title('Network Properties', fontsize=16)
pl.tick_params(labelsize=16)
pl.legend(loc='best')
pl.show()
