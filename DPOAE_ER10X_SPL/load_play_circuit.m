...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [f1,RP,FS]=load_play_circuit(FS_tag,fig_num,GB_ch,Noise_Amp,IAC)
...
CIR_PATH='play_noise_kc_serial_buttonin_OAE.rcx'; %The *.rco circuit used to play the files
