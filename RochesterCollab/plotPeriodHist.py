...
froot = '/home/hari/Documents/PythonCodes/research/CarneyCollab/'
bf = '4k'
...
for k, SNR in enumerate(SNRs):
    fname = 'Hari_' + bf + 'cell_SNR' + SNR + 'data.mat'
    ...
    pl.xlim((0, 500))
    pl.ylabel('Trial #', fontsize=20)
    pl.title('SNR = ' + str(actualSNR[k]) + ', BF = ' + bf, fontsize=20)
